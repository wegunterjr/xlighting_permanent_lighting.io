...
The Reserve form emails **info@utahlightcontrollers.com** via FormSubmit.

The first time someone submits, FormSubmit sends a confirmation to that inbox. Click it once, then every later reservation lands as a normal email.
